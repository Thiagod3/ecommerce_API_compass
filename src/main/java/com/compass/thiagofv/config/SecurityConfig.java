...
import com.compass.thiagofv.securityJwt.JwtTokenFilter;
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        return http
                ...
                .authorizeRequests(authorizeRequests -> authorizeRequests
                        ...
                        .requestMatchers("/vendas/delete", "/vendas/atualizar").access("@mySecurityService.isOwnerOfSale(authentication, #id)")
                        // Restrição explícita para o endpoint /users
